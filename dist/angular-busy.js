                    ...
                    if (!templateElement || currentTemplate !== options.templateUrl || backdrop !== options.backdrop) {
                        ...
                        $http.get(currentTemplate, {cache: $templateCache}).success(function(indicatorTemplate) {
                            ...
                            if (options.backdrop) {
                                ...
                                if (typeof options.backdropAppendTo === 'string') {
                                    angular.element(document.querySelector(options.backdropAppendTo)).append(backdropElement);
                                }
                                else {
                            ...
                            var template = '<div class="cg-busy cg-busy-animation ' + (options.animationClass ? options.animationClass: '') + ' ng-hide" ng-show="$cgBusyIsActive()">' + indicatorTemplate + '</div>';
